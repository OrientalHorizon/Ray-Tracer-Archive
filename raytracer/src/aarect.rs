...
impl<T: Material> XyRect<T> {
    pub fn construct(x0: f64, x1: f64, y0: f64, y1: f64, k: f64, mat: T) -> Self {
        Self {
            mp: mat,
            x0,
            x1,
...
impl<T: Material> XzRect<T> {
    pub fn construct(x0: f64, x1: f64, z0: f64, z1: f64, k: f64, mat: T) -> Self {
        Self {
            mp: mat,
            x0,
            x1,
...
impl<T: Material> YzRect<T> {
    pub fn construct(y0: f64, y1: f64, z0: f64, z1: f64, k: f64, mat: T) -> Self {
        Self {
            mp: mat,
            y0,
            y1,
